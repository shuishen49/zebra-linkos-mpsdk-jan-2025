...
public class ConnectionBuilderDemo extends DemoDialog {
    ...
    public ConnectionBuilderDemo(JFrame owner) {
        ...
        connectionBuilderPrefixCombo = new JComboBox(new String[] { "", "TCP_MULTI", "TCP", "TCP_STATUS", "REMOTE_MULTI", "REMOTE", "REMOTE_STATUS", "USB_DIRECT" });
        ...
        JLabel ipAddressLabel = new JLabel("USB Driver/IP Address/USB Direct/Serial Number :");
