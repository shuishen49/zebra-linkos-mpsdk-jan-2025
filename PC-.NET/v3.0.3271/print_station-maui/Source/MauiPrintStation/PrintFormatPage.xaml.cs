    ...
    public partial class PrintFormatPage : ContentPage {
        ...
        private async Task PopulateVariableFieldListAsync() {
            await Task.Factory.StartNew(() => {
                ...
                try {
                    viewModel.FormatVariableList.SafeClear();
                } catch (NotImplementedException) {
                    viewModel.FormatVariableList.SafeClear(); // Workaround for Xamarin.Forms.Platform.WPF issue: https://github.com/xamarin/Xamarin.Forms/issues/3648
                }
            });
            ...
            try {
                await Task.Factory.StartNew(() => {
                    ...
                    foreach (FieldDescriptionData variableField in variableFields) {
                        viewModel.FormatVariableList.SafeAdd(new FormatVariable {
