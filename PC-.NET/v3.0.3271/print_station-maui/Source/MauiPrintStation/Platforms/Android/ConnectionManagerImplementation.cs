...
namespace MauiPrintStation
{
    public class ConnectionManagerImplementation : IConnectionManager
    {
        ...
        private const string ActionUsbPermission = "com.zebra.MauiPrintStation.USB_PERMISSION";
                ...
                try {
                    ...
                    if (usbDevice != null) {
                        if (!usbManager.HasPermission(usbDevice)) {
                            PendingIntent permissionIntent = PendingIntent.GetBroadcast(Android.App.Application.Context, 0, new Intent(ActionUsbPermission), PendingIntentFlags.Mutable);
