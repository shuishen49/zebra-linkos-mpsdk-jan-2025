...
import com.zebra.android.devdemo.ConnectionScreenSecondary;
...
public class SmartCardDemo extends ConnectionScreenSecondary {
    ...
    private void connectAndGetData() {
        ...
        try {
            ...
            if (smartcardReader != null) {
                ...
                runOnUiThread(() -> SmartCardDemo.this.response.setText(toHexString(response)));
            } else {
