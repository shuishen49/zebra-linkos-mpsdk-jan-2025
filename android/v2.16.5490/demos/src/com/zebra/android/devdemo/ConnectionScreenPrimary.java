...
public abstract class ConnectionScreenPrimary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.connection_screen_primary);
    ...
    protected boolean isBleSelected() {
