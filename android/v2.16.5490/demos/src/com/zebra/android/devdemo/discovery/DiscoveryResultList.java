...
public abstract class DiscoveryResultList extends ExpandableListActivity implements DiscoveryHandler {
    ...
    private class ZebraExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
            ...
            } else if (printerItems.get(groupPosition) instanceof DiscoveredPrinterBluetoothLe) {
                itemView.getText1().setText(((DiscoveredPrinterBluetoothLe) printerItems.get(groupPosition)).address);
                itemView.getText2().setText(((DiscoveredPrinterBluetoothLe) printerItems.get(groupPosition)).friendlyName);
            }
            return itemView;
        }
