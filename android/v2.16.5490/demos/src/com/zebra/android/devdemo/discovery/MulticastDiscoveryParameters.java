...
public class MulticastDiscoveryParameters extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button discoverButton = findViewById(R.id.do_multicast_discovery);
        ...
        discoverButton.setOnClickListener(v -> {
            ...
            EditText hopsText = findViewById(R.id.multicast_hops);
            try {
